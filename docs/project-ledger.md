...
- **用户场景化自动验收 → scenario-first M-1、M0 case-aware journey contract、M2 report generator 与 M5 L1 runner 已完成；M1 Case 1 settings persistence、structured connection check、Quick Run / Agent Run provider summary 已接线，optional L3-local、M3 GUI smoke 与 M4 external check-mode 尚未接线。**
