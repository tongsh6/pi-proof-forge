...
- **用户场景化自动验收 → scenario-first M-1、M0 case-aware journey contract 与 M2 report generator 已完成；M1 Case 1 settings persistence + structured connection check 已接线，run-page summary 与 M5 runner 尚未接线。**
