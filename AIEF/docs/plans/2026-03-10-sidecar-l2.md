...
| `resume.upload` | 5 | ✅ |
| `resume.getPreview` | 5 | ✅ |
| `resume.exportPdf` | 5 | ✅ (full implementation - supports PDF copy + Markdown→PDF conversion) |
| `submission.list` | 6 | ✅ |
| `submission.retry` | 6 | ✅ (persists state to submission_log.json) |
| `overview.get` (fix) | 1 | ✅ |
...
**Final PR:** #13 (Sidecar L2 implementation), #14 (review fixes), #17 (Markdown→PDF export)  
**Test Status:** All 113 sidecar tests passing  
**UI Build:** Successful

### Additional Fixes After Initial Implementation
- ✅ Fixed evidence folded scalar corruption (PR #12)
- ✅ Fixed submission retry persistence (PR #14)
- ✅ Fixed UI race conditions in evidence/resume pages (PR #14)
- ✅ Implemented real Markdown→PDF export (PR #17)
